...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    date: "заглушка",
    text: "Текст отзыва — заглушка. Отзыв родителя о первом визите ребёнка: здесь важно, как прошла адаптация, а не только результат лечения.",
  },
  {
    author: "Имя Л.",
    doctor: "doctor-3",
    service: "Эстетика",
    date: "заглушка",
    text: "Текст отзыва — заглушка. Отзыв после виниров или реставрации — самый частый повод прислать фото, но публиковать его можно только с письменного согласия.",
  },
  {
    author: "Имя Р.",
    doctor: "doctor-1",
    service: "Хирургия",
    date: "заглушка",
    text: "Текст отзыва — заглушка. Короткий отзыв после удаления зуба мудрости.",
  },
];

export type ReviewPlatform = { name: string; url: string | null };

/**
 * Площадки, где пациенты оставляют отзывы. Ссылка появится, когда клиника
 * пришлёт адреса своих карточек; до этого площадка показывается без ссылки —
 * ссылка «#» выглядит рабочей и никуда не ведёт.
 */
export const reviewPlatforms: ReviewPlatform[] = [
  { name: "Яндекс Карты", url: null },
  { name: "2ГИС", url: null },
  { name: "ПроДокторов", url: null },
  { name: "НаПоправку", url: null },
];

export type Direction = { title: string; text: string };

/**
 * Как добраться. ЗАГЛУШКИ — клиника пришлёт реальные ориентиры. Писать
 * стоит так, как объясняют по телефону: от выхода из метро, с поворотами и
 * приметами, а не «5 минут пешком».
 */
export const directions: Direction[] = [
  {
    title: "На метро",
    text: "Станция [ЗАГЛУШКА], выход №0. Направо до перекрёстка, затем налево — вход с торца здания, рядом с [ОРИЕНТИР].",
  },
  {
    title: "На машине",
    text: "Въезд со стороны [УЛИЦА]. В навигаторе ищите «Dental Buro» — точка стоит у нужного входа, а не в центре здания.",
  },
  {
    title: "Парковка",
    text: "[ЗАГЛУШКА: платная городская / своя у входа / во дворе]. Если парковка своя — напишите в комментарии к записи номер машины, администратор внесёт его в пропуск.",
  },
];
