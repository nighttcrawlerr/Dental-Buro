 ...
 *
 * Форма записи появится здесь на этапе 3, вместе с отправкой заявок в
 * Telegram. Пока это кнопки: класть на главную форму, которая никуда не
 * отправляет, нельзя — её заполнят.
 */
